...
public interface RutaPersonalDAO extends GenericDAO<RutaPersonal, RutaPersonalId>{
	...
	void actualizar(Integer codigoRuta, Integer codigoPersonal, Integer numeroEncuestas, String fechaInicio, String fechaFin, Integer nroEncuestasPorDia, Integer correlativoInicial);
